...
petting-success-dehydrated-carp = Вы гладите { $target } по { POSS-ADJ($target) } маленькой сухой голове. Похоже, вы теперь нравитесь ему!
...
petting-success-derelict-cyborg = Вы погладили { THE($target) } по { POSS-ADJ($target) } ржавой металлической голове.
petting-failure-honkbot = Вы тянетесь погладить { $target }, но { $target } хонкает и уворачивается!
petting-success-station-ai = Вы погладили { THE($target) } на { POSS-ADJ($target) } холодном, квадратном экране.
...
petting-failure-derelict-cyborg = Вы протягиваете руку, чтобы погладить { THE($target) }, но { POSS-ADJ($target) } ржавый и зазубренный внешний вид заставляет вас передумать.
petting-failure-station-ai = Вы протягиваете руку, чтобы погладить { THE($target) }, но { SUBJECT($target) } { CONJUGATE-BASIC($target, "zap", "zaps") } отводит вашу кисть руки.
petting-success-station-ai-others = { CAPITALIZE(THE($user)) } гладит { $target } по { POSS-ADJ($target) } холодному, квадратному экрану.
